...
static input double Entry_Amount    = 0.01; // Amount for a new position [lot]
static input double Maximum_Amount  = 2; // Maximum position amount [lot]
...
input int Stop_Loss   = 215; // Stop Loss [point]
input int Take_Profit = 250; // Take Profit [point]
input int Break_Even  = 0; // Break Even [point]
static input double Martingale_Multiplier=0; // Martingale Multiplier

static input string IndicatorName1 = "Projection Bands v3"; // ------ Indicator parameters ------
input int Slot1IndParam0 = 110; // Period
...
class ProjectionBandsv3 : public Indicator
  {
public:
                     ProjectionBandsv3(SlotTypes slotType)
     {
      SlotType=slotType;
...
//|                                                                  |
//+------------------------------------------------------------------+
void ProjectionBandsv3::Calculate(DataSet &dataSet)
  {
   Data=GetPointer(dataSet);


// Reading the parameters
   int ProjectionPeriod=(int)NumParam[0].Value;
...
// Calculation
   ...
   double j2lg[];      ArrayResize(j2lg,Data.Bars);      ArrayInitialize(j2lg, 0);
   ...
   for(int iBar=iFirstBar; iBar<Data.Bars; iBar++)
     {
      ...
      for(int i=0; i<ProjectionPeriod; i++,n--)
        {
         double price=Data.Low[iBar-i];
         sumxy += n*price;
         sumy  +=   price;

         double price1=Data.High[iBar-i];
         sumxy1 += n*price1;
         sumy1  +=   price1;
        }

      double slopel= 0.00;
      double top   = ProjectionPeriod*sumxy - sumx*sumy;
      double bot   = ProjectionPeriod*sumx2 - sumx*sumx;
      slopel=top/bot;

      double slopeh = 0.00;
      double top1   = ProjectionPeriod*sumxy1 - sumx*sumy1;
      double bot1   = ProjectionPeriod*sumx2 - sumx*sumx;
      slopeh=top1/bot1;

      double max2 = Data.High[iBar];
      double min2 = Data.Low[iBar];

      for(int k=1; k<ProjectionPeriod; k++)
        {
         min2 = MathMin(Data.Low[iBar-k]+k*slopel, min2);
         max2 = MathMax(max2, Data.High[iBar-k]+k*slopeh);
        }
...
// Saving the components
   ...
   ArrayCopy(Component[1].Value,j2lg);
...
// Sets the Component's type.
   ...
   if(SlotType==SlotTypes_Open || SlotType==SlotTypes_Close)
      ...
      if(ProjectionPeriod>1)
        {
         for(int iBar=iFirstBar; iBar<Data.Bars; iBar++)
           { // Covers the cases when the price can pass through the band without a signal.
            ...
            if(ListParam[0].Text=="Enter long at the Upper Band" || 
               ListParam[0].Text=="Exit long at the Upper Band")
              {
     ...
     {
      if(ListParam[0].Text=="The bar opens below the Upper Band")
        {
         BandIndicatorLogic(iFirstBar,iPrvs,adUpBand,adDnBand,Component[3],Component[4],
                            BandIndLogic_The_bar_opens_below_the_Upper_Band);
        }
      else if(ListParam[0].Text=="The bar opens above the Upper Band")
        {
         BandIndicatorLogic(iFirstBar,iPrvs,adUpBand,adDnBand,Component[3],Component[4],
                            BandIndLogic_The_bar_opens_above_the_Upper_Band);
        }
      else if(ListParam[0].Text=="The bar opens below the Lower Band")
        {
         BandIndicatorLogic(iFirstBar,iPrvs,adUpBand,adDnBand,Component[3],Component[4],
                            BandIndLogic_The_bar_opens_below_the_Lower_Band);
        }
      else if(ListParam[0].Text=="The bar opens above the Lower Band")
        {
         BandIndicatorLogic(iFirstBar,iPrvs,adUpBand,adDnBand,Component[3],Component[4],
                            BandIndLogic_The_bar_opens_above_the_Lower_Band);
        }
      else if(ListParam[0].Text=="The bar opens below the Upper Band after opening above it")
        {
         BandIndicatorLogic(iFirstBar,iPrvs,adUpBand,adDnBand,Component[3],Component[4],
                            BandIndLogic_The_bar_opens_below_Upper_Band_after_above);
        }
      else if(ListParam[0].Text=="The bar opens above the Upper Band after opening below it")
        {
         BandIndicatorLogic(iFirstBar,iPrvs,adUpBand,adDnBand,Component[3],Component[4],
                            BandIndLogic_The_bar_opens_above_Upper_Band_after_below);
        }
      else if(ListParam[0].Text=="The bar opens below the Lower Band after opening above it")
        {
         BandIndicatorLogic(iFirstBar,iPrvs,adUpBand,adDnBand,Component[3],Component[4],
                            BandIndLogic_The_bar_opens_below_Lower_Band_after_above);
        }
      else if(ListParam[0].Text=="The bar opens above the Lower Band after opening below it")
        {
         BandIndicatorLogic(iFirstBar,iPrvs,adUpBand,adDnBand,Component[3],Component[4],
                            BandIndLogic_The_bar_opens_above_Lower_Band_after_below);
        }
      else if(ListParam[0].Text=="The position opens above the Upper Band")
        {
      ...
      else if(ListParam[0].Text=="The position opens below the Upper Band")
        {
      ...
      else if(ListParam[0].Text=="The position opens above the Lower Band")
        {
      ...
      else if(ListParam[0].Text=="The position opens below the Lower Band")
        {
      ...
      else if(ListParam[0].Text=="The bar closes below the Upper Band")
        {
         BandIndicatorLogic(iFirstBar,iPrvs,adUpBand,adDnBand,Component[3],Component[4],
                            BandIndLogic_The_bar_closes_below_the_Upper_Band);
        }
      else if(ListParam[0].Text=="The bar closes above the Upper Band")
        {
         BandIndicatorLogic(iFirstBar,iPrvs,adUpBand,adDnBand,Component[3],Component[4],
                            BandIndLogic_The_bar_closes_above_the_Upper_Band);
        }
      else if(ListParam[0].Text=="The bar closes below the Lower Band")
        {
         BandIndicatorLogic(iFirstBar,iPrvs,adUpBand,adDnBand,Component[3],Component[4],
                            BandIndLogic_The_bar_closes_below_the_Lower_Band);
        }
      else if(ListParam[0].Text=="The bar closes above the Lower Band")
        {
         BandIndicatorLogic(iFirstBar,iPrvs,adUpBand,adDnBand,Component[3],Component[4],
                            BandIndLogic_The_bar_closes_above_the_Lower_Band);
        }
...
Indicator *IndicatorManager::CreateIndicator(string indicatorName,SlotTypes slotType)
  {
   ...
   if (indicatorName == "Projection Bands v3") return new ProjectionBandsv3(slotType);
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   strategy.MaxOpenLots            = 2;
   strategy.UseAccountPercentEntry = false;
   strategy.EntryLots              = 0.01;
   ...
   strategy.Description            = "Exported on 5/13/2022 from Forex Strategy Builder Professional, v3.8.8";
   strategy.RecommendedBars        = 1000;
   strategy.FirstBar               = 222;
   strategy.MinBarsRequired        = 223;
   ...
   strategy.Slot[0].IndicatorName    = "Ross Hook";
   ...
   strategy.Slot[0].IndicatorPointer = indicatorManager.CreateIndicator("Ross Hook", SlotTypes_Open);
   ...
   strategy.Slot[0].IndicatorPointer.ListParam[0].Text    = "Enter long at Up Ross hook";

   strategy.Slot[1].IndicatorName    = "Projection Bands v3";
   ...
   strategy.Slot[1].IndicatorPointer = indicatorManager.CreateIndicator("Projection Bands v3", SlotTypes_OpenFilter);

   strategy.Slot[1].IndicatorPointer.ListParam[0].Enabled = true;
   strategy.Slot[1].IndicatorPointer.ListParam[0].Caption = "Logic";
   strategy.Slot[1].IndicatorPointer.ListParam[0].Index   = 5;
   strategy.Slot[1].IndicatorPointer.ListParam[0].Text    = "The position opens above the Upper Band";

   strategy.Slot[1].IndicatorPointer.NumParam[0].Enabled = true;
   strategy.Slot[1].IndicatorPointer.NumParam[0].Caption = "Period";
   ...
   double ActionTrade::NormalizeEntrySize(double size)
     {
      ...
      {
         string message = "The order is canceled becasue the entry amount is below the allowed minimum.";
         Print(message);
         return (0);
      }
...
/*STRATEGY CODE <?xml version=\"1.0\"?><strategy><programName>Forex Strategy Builder Professional</programName><programVersion>v3.8.8</programVersion><strategyName>Strategy</strategyName><profileName>Default profile</profileName><dataSourceName>Alpari MT5</dataSourceName><instrumentSymbol>EURUSD</instrumentSymbol><instrumentPeriod>1</instrumentPeriod><sameDirSignalAction>Add</sameDirSignalAction><oppDirSignalAction>Nothing</oppDirSignalAction><maxOpenLots>2</maxOpenLots><useAccountPercentEntry>False</useAccountPercentEntry><entryLots>0.01</entryLots><addingLots>1</addingLots><reducingLots>1</reducingLots><useMartingale>False</useMartingale><martingaleMultiplier>2</martingaleMultiplier><description>Exported on 5/13/2022 from Forex Strategy Builder Professional, v3.8.8</description><recommendedBars>1000</recommendedBars><openFilters>1</openFilters><closeFilters>0</closeFilters><firstBar>222</firstBar><minBarsRequired>223</minBarsRequired><permanentStopLoss usePermanentSL=\"True\" permanentSLType=\"Relative\">215</permanentStopLoss><permanentTakeProfit usePermanentTP=\"True\" permanentTPType=\"Relative\">250</permanentTakeProfit><breakEven useBreakEven=\"False\">1000</breakEven><slot slotNumber=\"0\" slotType=\"Open\"><indicatorName>Ross Hook</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>Enter long at Up Ross hook</value></listParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot><slot slotNumber=\"1\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>Projection Bands v3</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>5</index><value>The position opens above the Upper Band</value></listParam><numParam paramNumber=\"0\"><caption>Period</caption><value>110</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot><slot slotNumber=\"2\" slotType=\"Close\"><indicatorName>Day Closing</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>Exit the market at the end of the day</value></listParam><listParam paramNumber=\"1\"><caption>Base price</caption><index>0</index><value>Close</value></listParam></slot></strategy> */
//+------------------------------------------------------------------+
